...
ההרשמה פתוחה וחופשית — כל אחד יכול להירשם בעצמו. נכנסים לאתר, נרשמים עם כתובת אימייל וסיסמה (לפחות 6 תווים), ומתחברים. מיד לאחר ההרשמה אפשר להתחיל לחפש מילים, לשמור אותן ולצפות בהיסטוריה.
